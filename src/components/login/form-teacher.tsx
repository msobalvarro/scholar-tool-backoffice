...
export const FormTeacher = () => {
  ...
  return (
    <div
      ...
      <div className='mb-8'>
        <h1 className='text-3xl font-black tracking-tight mb-2'>Bienvenido Profesor</h1>
      ...
      <form className='flex flex-col gap-5'>
        ...
        <button
          className='mt-4 w-full h-12 bg-secondary text-white font-bold rounded-lg shadow-md hover:shadow-lg transition-all transform active:scale-[0.98] flex items-center justify-center gap-2'
          type='button'>
