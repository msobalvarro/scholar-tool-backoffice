...
import type { StudentPersonalCardProps } from '@/dtos/inputs/student.input'
          ...
          <div className='flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5'>
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                required
                {...register('paternalLastName', { required: 'El apellido paterno es obligatorio' })}
                className={errors.paternalLastName ? 'border-destructive focus-visible:ring-destructive' : ''}
              />
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                className={errors.maternalLastName ? 'border-destructive focus-visible:ring-destructive' : ''}
              />
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                className={errors.birthday ? 'border-destructive focus-visible:ring-destructive' : ''}
              />
              {errors.birthday && (
                <p className='text-xs font-medium text-destructive mt-1'>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select onValueChange={field.onChange} value={field.value}>
                    <SelectTrigger className={`w-full ${errors.gender ? 'border-destructive focus-visible:ring-destructive' : ''}`}>
